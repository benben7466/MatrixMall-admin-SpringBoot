package com.bzq.matrixmall.model.bo;
...
public class RouteBO {
    ...
    private MenuTypeEnum type;//菜单类型(1-菜单 2-目录 3-外链 4-按钮)
    ...
    private Integer keepAlive;//【菜单】是否开启页面缓存(1:是 0:否)
    private String params;//【菜单】路由参数
